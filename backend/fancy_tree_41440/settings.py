"""
Django settings for fancy_tree_41440 project.
...
ROOT_URLCONF = 'fancy_tree_41440.urls'
...
WSGI_APPLICATION = 'fancy_tree_41440.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_tree_41440 API",
    "DESCRIPTION": "API documentation for fancy_tree_41440 App",
    "VERSION": "v1",
}
